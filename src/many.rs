...
pub fn encode_request(_req: Request) -> Result<Request, JsValue> {
    // Hijack the request and send it to fake API for testing
    let req_url = "https://jsonplaceholder.typicode.com/todos/1";
...
fn make_request_init(_req_body: JsValue) -> RequestInit {
